...
- `nla/least_squares`: normal equations, Householder QR, Givens QR, classical Gram-Schmidt QR, modified Gram-Schmidt QR and stability diagnostics for least-squares solvers.
